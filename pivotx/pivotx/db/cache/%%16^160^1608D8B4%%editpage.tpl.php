<?php /* Smarty version 2.6.26, created on 2015-05-14 12:02:51
         compiled from editpage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'editpage.tpl', 16, false),array('modifier', 'escape', 'editpage.tpl', 17, false),array('function', 'hook', 'editpage.tpl', 60, false),array('function', 'date', 'editpage.tpl', 206, false),)), $this); ?>
...
<div id="container">
    ...
    <form id="form1" name="form1" method="post" action="index.php?page=page&amp;uid=<?php echo $this->_tpl_vars['page']['uid']; ?>
" class="edit-page">
        ...
        <div class="leftcolumn">
            ...
            <table border="0" cellspacing="0" class="formclass" width="650">
                <tr class="field-title-and-uri">
                    ...
                    <td width="510"><input id="title" name="title" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['page']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" class="xl lesswide"
                    <?php if ($this->_tpl_vars['page']['uid'] == 0): ?>onkeyup="setSafename('title','uri','permalink');" onchange="setSafename('title','uri','permalink');"<?php endif; ?> />
...
<span id="permalink"><?php echo $this->_tpl_vars['page']['uri']; ?>
</span><?php echo $this->_tpl_vars['page']['link_end']; ?>
                ...
                <tr id="permalink-edit" class="field-title-and-uri">
                    ...
                    <td><input id="uri" name="uri" type="text" value="<?php echo $this->_tpl_vars['page']['uri']; ?>
" class="lesswide"
                ...
                <input name="subtitle" type="hidden" value="<?php echo $this->_tpl_vars['page']['subtitle']; ?>
" />
                <?php else: ?>
                <tr class="field-subtitle">
                    ...
                    <td><input name="subtitle" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['page']['subtitle'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></td>
                </tr>
                <?php endif; ?>    
...
' <?php if ($this->_tpl_vars['template'] == $this->_tpl_vars['page']['template']): ?>selected="selected"<?php endif; ?>>
            ...
            <?php echo smarty_hook(array('name' => "page-introduction-before",'value' => $this->_tpl_vars['page']), $this);?>
            ...
            <div class="field-introduction">
                ...
                <textarea name="introduction" id="introduction" class="Editor" rows='50'
                    cols='4'><?php echo ((is_array($_tmp=$this->_tpl_vars['page']['introduction'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</textarea>
            </div>
    
            <?php echo smarty_hook(array('name' => "page-body-before",'value' => $this->_tpl_vars['page']), $this);?>
            ...
            <div class="field-body">
                ...
                <textarea name="body" id="body" class="Editor" rows='50'
                    cols='4'><?php echo ((is_array($_tmp=$this->_tpl_vars['page']['body'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</textarea>

                <br />
            </div>

            <?php echo smarty_hook(array('name' => "page-keywords-before",'value' => $this->_tpl_vars['page']), $this);?>
            ...
            <table border="0" cellspacing="0" class="formclass field-keywords" width="650">
                <tr>
                    ...
                    <td width="510">
                        <input name="keywords" id="keywords" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['page']['keywords'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
            ...
            <?php echo smarty_hook(array('name' => "page-bottom",'value' => $this->_tpl_vars['page']), $this);?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <div class="rightcolumn">
            ...
            <table border="0" cellpadding="0" class="formclass">
                <tr class="meta-buttons meta-buttons-right">
                    ...
                    <?php echo smarty_hook(array('name' => "page-chapter-before",'value' => $this->_tpl_vars['page']), $this);?>
    ...
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['chapter']):
?>
                                <?php if ($this->_tpl_vars['chapter']['chaptername'] != ""): ?>
                                    <option value='<?php echo $this->_tpl_vars['key']; ?>
' <?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['page']['chapter']): ?>selected="selected"<?php endif; ?>>
                                        <?php echo $this->_tpl_vars['chapter']['chaptername']; ?>
                ...
                <tr class="field-order">
                    ...
                    <td><input name="sortorder" id="sortorder" type="text" value="<?php echo $this->_tpl_vars['page']['sortorder']; ?>
" /></td>
                </tr>
                ...
                <tr class="field-publish">
                    <td colspan="2"><p><strong><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Publish on<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</strong></p>
                        ...
                        value="<?php echo smarty_date(array('date' => $this->_tpl_vars['page']['publish_date'],'format' => '%day%-%month%-%year%'), $this);?>
" size="15" />
                        <input name="publish_date2" type="text" class='input' id="publish_date2"
                        value="<?php echo smarty_date(array('date' => $this->_tpl_vars['page']['publish_date'],'format' => '%hour24%-%minute%'), $this);?>
" size="7" />
                    </td>
                </tr>
                                        <tr class="field-date">
                        ...
                        value="<?php echo smarty_date(array('date' => $this->_tpl_vars['page']['date'],'format' => '%day%-%month%-%year%'), $this);?>
" size="15" />
                        <input name="date2" id="date2" type="text" class='input field-date'
                        value="<?php echo smarty_date(array('date' => $this->_tpl_vars['page']['date'],'format' => '%hour24%-%minute%'), $this);?>
" size="7" />
                    </td>
                </tr>
                ...
                <tr class="field-edit_date">
                    <td colspan="2"><p><strong><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Last edited on<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</strong></p>
                        ...
                        value="<?php echo smarty_date(array('date' => $this->_tpl_vars['page']['edit_date'],'format' => '%day%-%month%-%year%'), $this);?>
" size="15" />
                        <input name="edit_date2" type="text" class='input' readonly='readonly'
                        value="<?php echo smarty_date(array('date' => $this->_tpl_vars['page']['edit_date'],'format' => '%hour24%-%minute%'), $this);?>
" size="7" />
                    </td>
                </tr>
...
" <?php if ($this->_tpl_vars['page']['user'] == $this->_tpl_vars['u']['username']): ?>selected="selected"<?php endif; ?> >
                        ...
                        <?php else: ?>
                            <input name="author" type="text" value="<?php echo $this->_tpl_vars['pageuser']['nickname']; ?>
" readonly="readonly" />
                        <?php endif; ?>
                    </td>
                </tr>
                <tr class="field-code">
                    ...
                    <td><input name="code" type="hidden" value="<?php echo $this->_tpl_vars['page']['uid']; ?>
" id="uid" /><?php echo $this->_tpl_vars['page']['uid']; ?>
</td>
                </tr>
                </tr>
                    <?php echo smarty_hook(array('name' => "page-code-after",'value' => $this->_tpl_vars['page']), $this);?>
